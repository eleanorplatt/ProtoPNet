        ...
        if is_train:
            if class_specific:
                if loss_coefficients is not None:
                    loss = (loss_coefficients['crs_ent'] * cross_entropy
                          + loss_coefficients['clst'] * cluster_cost
                          + loss_coefficients['sep'] * separation_cost
...
def train(model, device, dataloader, optimizer, class_specific=False, loss_coefficients=None, log=print):
