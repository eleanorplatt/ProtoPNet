...
joint_optimizer = torch.optim.Adam(joint_optimizer_specs).to(device)
joint_lr_scheduler = torch.optim.lr_scheduler.StepLR(joint_optimizer, step_size=joint_lr_step_size, gamma=0.1).to(device)
...
warm_optimizer = torch.optim.Adam(warm_optimizer_specs).to(device)

from settings import last_layer_optimizer_lr
last_layer_optimizer_specs = [{'params': ppnet.last_layer.parameters(), 'lr': last_layer_optimizer_lr}]
last_layer_optimizer = torch.optim.Adam(last_layer_optimizer_specs).to(device)
